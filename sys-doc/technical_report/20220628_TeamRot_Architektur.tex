...
\hline  
Subredditname & Der Name des Subreddits\\  
Kommentar & Text\\  
Zeitstempel & Text\\ 
KommentarID & Text\\  
UserID & Text\\  
...
Minimum & Text\\ 
Schlusswert & Text\\  
Dividenden-adjustierte Werte & Text\\  
Volumen & Text\\ 
\end{tabular}  
\end{center}  
\end{table} 
...
Reddiment ist ein webbasiertes Dashboard, welches den zeitlichen Verlauf von Sentiment und Erwähnungen bestimmter Schlüsselwörter in ausgewählten Subreddits dem Aktienverlauf gegenüberstellt. Durch die Auswahl eines Subreddits und eines oder mehrere Schlüsselwörter werden die Diagramme automatisch mit den vorhandenen Daten befüllt.
